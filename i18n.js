...
(function (global) {
  ...
  var DICT = {
    ru: {
      ...
      'home.index.03.bonus': 'Особые условия в партнёрских отелях: апгрейд категории номера, приоритет на ранний заезд и поздний выезд, комплименты в номере, кредиты на spa и трансферы, сопровождение до, во время и после поездки.',
