...
(function (global) {
  ...
  var DICT = {
    ru: {
      ...
      'service.hotels.bonus1': 'специальные тарифы благодаря прямым партнёрствам с отелями',
      'service.hotels.bonus2': 'апгрейд номера при наличии',
      'service.hotels.bonus3': 'ранний заезд и поздний выезд',
      'service.hotels.bonus4': 'завтраки, приветственные комплименты и приоритет по размещению',
    ...
    en: {
      ...
      'service.hotels.bonus1': 'special rates through our direct partnerships with hotels',
      'service.hotels.bonus2': 'a room upgrade, subject to availability',
      'service.hotels.bonus3': 'early check-in and late check-out',
      'service.hotels.bonus4': 'breakfast, welcome treats, and priority on rooms',
