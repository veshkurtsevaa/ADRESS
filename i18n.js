...
(function (global) {
  ...
  var DICT = {
    ru: {
      ...
      'home.index.03.bonus': 'Особые условия в отелях-партнёрах: апгрейд категории номера, приоритет на ранний заезд и поздний выезд, комплименты в номере, spa-кредиты и трансферы — и сопровождение до, во время и после поездки',
      ...
      'service.hotels.bonus1': 'особые условия и привилегии в отелях-партнёрах',
      ...
      'service.hotels.bonus4': 'комплименты в номере, spa-кредиты и трансферы',
    ...
    en: {
      ...
      'home.index.03.bonus': 'Special conditions at our partner hotels: a room-category upgrade, priority for early check-in and late check-out, in-room treats, spa credits and transfers — plus support before, during, and after the trip',
      ...
      'service.hotels.bonus2': 'a room-category upgrade, subject to availability',
      'service.hotels.bonus3': 'priority for early check-in and late check-out',
      'service.hotels.bonus4': 'in-room treats, spa credits, and transfers',
